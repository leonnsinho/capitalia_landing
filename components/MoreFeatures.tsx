            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative" style={{ zIndex: 2 }}>
                <div className="flex flex-col md:flex-row-reverse items-center gap-16">
                    ...
                    <div className="w-full md:w-1/2">
                        <div className="mb-12">
                             <h2 className="text-3xl md:text-4xl font-bold text-gray-900 uppercase tracking-wide drop-shadow-md">
                                Funcionalidades do <span className="text-emerald-300">Capitalia</span>
                             </h2>
